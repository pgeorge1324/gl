...
int main()
{
    ...
    // -------------------------
    Shader shader("../src/learnopengl/frame_buffer/frame_buffer.vs", "../src/learnopengl/frame_buffer/frame_buffer.fs");
    Shader screenShader("../src/learnopengl/frame_buffer/frame_buffer_screen.vs", "../src/learnopengl/frame_buffer/frame_buffer_screen.fs");
