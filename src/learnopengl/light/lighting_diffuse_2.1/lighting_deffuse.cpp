...
//    glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE);// macOs
    ...
    Shader lightShader = Shader("../src/shaders/light/shader.vs", "../src/shaders/light/shader.fs");
    Shader cubeShader = Shader("../src/shaders/light/cubeShader.vs", "../src/shaders/light/cubeShader.fs");
